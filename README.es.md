...
**Decisión:** carga manual por CSV, exportado directamente desde Meta Ads Manager. El script (`scripts/load_meta_ads_csv.py`) busca automáticamente el export más reciente en la carpeta de Descargas, para que el único paso manual real sea "exportar el CSV" — todo lo demás sigue automatizado.
